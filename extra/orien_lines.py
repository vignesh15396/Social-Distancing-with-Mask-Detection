...
def drawsafelines(image_np,Orientation,Line_Perc1,Line_Perc2):
    ...
    #print('image_np.shape',image_np.shape,'\nimage_np.shape[1]',image_np.shape[1],'\nposii',posii)
    ...
    if(Orientation=="bt"):
        ...
        #print('Line_Position1',Line_Position1,'\nLine_Position2',Line_Position2)
        ...
        #cv2.line(img=image_np, pt1=(0, ), pt2=(image_np.shape[1], 45), color=(0, 255, 0),thickness=2, lineType=8, shift=0)
